...
x3, y3 = 300, 200  # coordonnées initiales du soleil
...
oval3 = can1.create_oval(x3-15,y3-15,x3+15,y3+15,width=2,fill='blue') # charge 1

oval1 = can1.create_oval(x1-15,y1-15,x1+15,y1+15,width=2,fill='blue') # charge 2
